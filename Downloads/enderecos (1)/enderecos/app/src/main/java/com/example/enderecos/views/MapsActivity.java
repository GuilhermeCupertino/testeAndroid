...
import com.example.enderecos.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    //FACOM Lati=-20.50232, // Longi=-54.61349
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        endereco = db.enderecoModel().getEndereco(dbEnderecoID);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //Endereco endereco = db.enderecoMode
        lati = endereco.getLatitude();
        longi = endereco.getLongitude();

        // Add a marker in Sydney and move the camera
        Log.d("Map", "Id: " + dbEnderecoID + lati + longi);
        LatLng end = new LatLng(longi, lati);
        mMap.addMarker(new MarkerOptions().position(end).title("Marker"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(end));
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(end, 18));
